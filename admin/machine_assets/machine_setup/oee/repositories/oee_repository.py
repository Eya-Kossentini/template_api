...
class KPIOeeRepository:
    ...
    def _extract_list_data(self, data: Any, source_name: str) -> List[Dict[str, Any]]:
        ...
        raise HTTPException(status_code=500, detail=f"Unexpected {source_name} format: {type(data).__name__}")
    ...
    def get_machine_condition_data(
        ...
        return self._extract_list_data(data, "machine condition data")
