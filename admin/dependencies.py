...
from admin.config import SECRET_KEY, ALGORITHM, TOKEN_URL
from admin.permission import expand_permission_groups
from admin.utils import verify_token

oauth2_scheme = OAuth2PasswordBearer(tokenUrl="https://auth_demo.momes-solutions.com/auth/token")
